    ...
    <div className="min-h-screen bg-[#F8F9FA] flex font-sans text-gray-900">
      ...
      <aside className="w-20 lg:w-64 bg-white border-r border-gray-200 flex flex-col fixed h-full z-10 transition-all duration-300">
        <div className="h-16 flex items-center px-6 border-b border-gray-100">
          ...
          <span className="font-semibold text-lg hidden lg:block">RealData</span>
        </div>

        <nav className="flex-1 py-6 px-3 space-y-1">
          <button 
            onClick={() => setActiveMenu('overview')}
            className={`w-full flex items-center px-3 py-2 rounded-lg text-sm font-medium transition-colors ${activeMenu === 'overview' ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-50'}`}
          >
          ...
          <button 
            ...
            className={`w-full flex items-center px-3 py-2 rounded-lg text-sm font-medium transition-colors ${activeMenu === 'projects' ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-50'}`}
          >
            <FolderOpen className="w-5 h-5 mr-3" />
            <span className="hidden lg:block">All Projects</span>
          </button>
          <button className="w-full flex items-center px-3 py-2 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-50 transition-colors">
            <PieChart className="w-5 h-5 mr-3" />
            <span className="hidden lg:block">Global Reports</span>
          </button>
        </nav>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
              ...
              <h3 className="text-3xl font-bold text-gray-900 mt-1">
                {isLoading ? '...' : stats.totalRows.toLocaleString()}
              </h3>
            </div>
          ...
          {isLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {projects.length === 0 && !isCreating && (
                    <div className="col-span-full text-center py-24 bg-white rounded-xl border border-dashed border-gray-300">
